...
const Galleries = () => {
  ...
  return (
    <>
      ...
      {!loading ? (
        <div className="min-h-screen  bg-gradient-to-br from-emerald-50 to-slate-400">
          <h1 className="font-briemhand text-center text-2xl md:text-4xl font-bold py-4 underline-offset-8 underline">
          ...
          <div className="flex py-4 justify-center items-center gap-5">
            <button
              className=" bg-slate-700 w-[200px] py-2 rounded-full text-white font-bold hover:bg-slate-600 duration-500 scale-100 hover:scale-105"
              onClick={() => {
